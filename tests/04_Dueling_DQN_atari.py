...
from src.agents import DuelingDQNAgent
...
#%%
save_dir = "result/DuelingDQN/atari/"
...
for t in range(agent.config.max_steps):
    ...
    if done:
        ...
        obs = next_obs
end_time = time.time()
print(f"WorkingTime[{DuelingDQNAgent.__name__}]: {end_time-start_time:.4f} sec\n")
...
save_model_name = "/home/railab/Workspace/2023-RL-Seminar/notebooks/result/DuelingDQN/atari/BreakoutNoFrameskip-v4_2023_07_05_02_46_49.pt"
